...
<?php 
    ...
    if (isset($_POST['update'])) {
      ...
      $prodi = $_POST['prodi'];
      $sql ="UPDATE dosen SET nip = '$nip', nama = '$nama', alamat = '$alamat', jabatan_akademik = '$jabatan_akademik', prodi = '$prodi' where nip ='$nip' ";
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded hs-scroll-trigger" href="#add-user">Edit Dosen</a>
          </li>
        </ul>
      </div>
    </div>
