<?php 
    ...
    if (isset($_POST['Submit'])) {
      ...
      $prodi = $_POST['prodi'];
      $sql = "INSERT INTO dosen(nip,nama,alamat,jabatan_akademik,prodi) VALUES('$nip', '$nama', '$alamat', '$jabatan_akademik', '$prodi')";
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded hs-scroll-trigger" href="#add-user">Add Dosen</a>
          </li>
        </ul>
      </div>
    </div>
