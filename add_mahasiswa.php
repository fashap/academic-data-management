<?php 
    ...
    if (isset($_POST['Submit'])) {
      ...
      $sql = "INSERT INTO mahasiswa (nrp,nama,idProdi,jenisKelamin,tanggaLahir) VALUES('$nrp', '$nama', '$prodi', '$jenis_kelamin','$tanggaLahir')";
                ...
                <select name="idProdi" class="form-control">
                  ...
                  <?php
                    ...
                    while ($data_prodi = mysqli_fetch_array($result_prodi)) {
                      echo "<option value= ".$data_prodi['idProdi']."> ".$data_prodi['namaProdi']." </option>";
                    }
                  ?>
                </select>
              </div>
            ...
            <div class="control-group">
             ...
             <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                ...
                <input class="form-control datepicker" name="tanggalLahir" type ="text" placeholder=" Masukan Tanggal Lahir" required="required">
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <br>
